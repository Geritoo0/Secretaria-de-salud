...
<head>
    ...
    <title>VPH || Secretaría Salud</title>
    ...
    <?php
        ...
        if (isset($_GET['id'])) {
            ...
            if ($fila_paciente = $resultado_paciente->fetch_assoc()) {
                ...
                echo "<td>
                <a href='cargar_vph.php?id=" . $fila_paciente['id_paciente'] . "' class='editar'>Cargar</a><br>
                <a href='editar_vph.php?id=" . $fila_paciente['id_paciente'] . "'class='editar'>Editar</a><br>
                </td>";
                echo "</tr>";
                echo "</table>";
            } else {
