...
<head>
    ...
    <title>Presión || Secretaría De Salud</title>
...
if (isset($_GET['id'])) {
    $id_paciente = $_GET['id'];
    echo "<a href='cargar_presion.php?id=" . $id_paciente . "'>Registrar Nueva Medición</a>";
    ...
    $query_presion = "SELECT sede, localidad, estado, derivacion, observacion, fecha FROM presion WHERE id_paciente = $id_paciente";
