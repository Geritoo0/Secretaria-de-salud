...
<head>
    ...
    <title>SIFILIS || Secretaría Salud</title>
...
<body>
    ...
    <?php
        ...
        if (isset($_GET['id'])) {
            ...
            $query_vph = "SELECT sifilis, observacion, derivacion FROM sifilis WHERE id_paciente = $id_paciente";
            ...
            if ($fila_paciente = $resultado_paciente->fetch_assoc()) {
                ...
                echo "<td>
                <a href='cargar_sifilis.php?id=" . $fila_paciente['id_paciente'] . "'>Cargar</a><br>
                <a href='editar_sifilis.php?id=" . $fila_paciente['id_paciente'] . "'>Editar</a><br>
                </td>";
                echo "</tr>";
                echo "</table>";
            } else {
